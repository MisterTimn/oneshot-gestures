    ...
    try:
        ...
        for num_oneshot_samples in [200]:
            ...
            try:
                ...
                num_backprops = 50000 / backprops_per_epoch
                for j in xrange(num_backprops):
                    ...
                    print("\nval err:\t{:5.2f}\nval acc:\t{:5.1f}%".format(val_loss,
                                                                     val_acc * 100.0))
                    ds.saveValues((train_loss,val_loss,val_acc,start_time-time.time()))
                ...
                # directory = "{}output/data-{}-retrain-{}-samples-{}/".format(base_dir_path, oneshot_class,retrain_layers,num_oneshot_samples)
