...
if __name__=='__main__':
    ...
    try:
        ...
        for num_oneshot_samples in [1,2,5,100]:
            for retrain_layers in [1]:
                ...
                if not os.path.exists("{}convnet_params/model-19x1/class-{}-noAugm/".format(base_dir_path,oneshot_class)):
                    os.makedirs("{}convnet_params/model-19x1/class-{}-noAugm/".format(base_dir_path,oneshot_class))

                save_param_path = "{}convnet_params/model-19x1/class-{}-noAugm/layers{}-samples{}".format(base_dir_path,oneshot_class,retrain_layers,num_oneshot_samples)
                min_val_acc = 0
                ...
                try:
                    ...
                    directory = "{}output/model-19x1/class-{}-noAugm/layers{}-samples{}/".format(base_dir_path, oneshot_class,retrain_layers,num_oneshot_samples)
                    ...
                    if not os.path.exists("{}output/model-19x1/class-{}-noAugm/test-acc.txt".format(base_dir_path,oneshot_class)):
                        open("{}output/model-19x1/class-{}-noAugm/test-acc.txt".format(base_dir_path,oneshot_class),'w').close()
                    with open("{}output/model-19x1/class-{}-noAugm/test-acc.txt".format(base_dir_path,oneshot_class), 'ab') as f:
