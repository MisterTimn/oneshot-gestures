        ...
        for ONESHOT_CLASS in xrange(1,20):
            ...
            for num_oneshot_samples in [1]:
                for retrain_layers in [1]:
                    ...
                    save_param_path = "{}layers{}-samples{}noaugm".format(PARAM_DIRECTORY, retrain_layers, num_oneshot_samples)
                    ...
                    try:
                        ...
                        directory = "{}layers{}-samples{}noaugm/".format(OUTPUT_DIRECTORY, retrain_layers, num_oneshot_samples)
