...
if __name__=='__main__':
    ...
    try:
        ...
        for ONESHOT_CLASS in xrange(1,20):
            ...
            for num_oneshot_samples in [1]:
                for retrain_layers in [1]:
                    ...
                    save_param_path = "{}layers{}-samples{}augm".format(PARAM_DIRECTORY, retrain_layers, num_oneshot_samples)
                    ...
                    try:
                        ...
                        directory = "{}layers{}-samples{}augm/".format(OUTPUT_DIRECTORY, retrain_layers, num_oneshot_samples)
